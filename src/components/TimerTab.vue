...
<template>
  <div class="flex text-gray-200 justify-between p-2">
    <button class="btn w-full" @click="tabSelect(false)" :class="{ 'btn-active': !isAsc }">Timer</button>
    <button class="btn w-full" @click="tabSelect(true)" :class="{ 'btn-active': isAsc }">Infinite</button>
  </div>
